...
var selectList = function selectList(block, title, labels) {
  ...
  var selectBlock = document.querySelector(block);
  var selectTitle = selectBlock.querySelector(title);
  var selectLabels = selectBlock.querySelectorAll(labels);
  ...
  selectLabels.forEach(function (item) {
